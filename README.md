...
```text
Основной загрузчик:
https://cdn.jsdelivr.net/gh/dedyushin/lampa-qbit-downloader/lampa-qbit-download.js

Отдельный плагин “Скачанное”:
https://cdn.jsdelivr.net/gh/dedyushin/lampa-qbit-downloader/lampa-qbit-media.js
```
